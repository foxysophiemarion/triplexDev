...
const errors = {
	EXTENDS_NO_SRC: 'Тег <extends> не содержит атрибут "src"',
	BLOCK_NO_NAME: 'Тег <block> не содержит атрибут "name"',
	UNEXPECTED_BLOCK: 'Неожиданный блок "%s"'
};
...
function mergeExtendsAndLayout(layoutTree, extendsNode, strictNames, slotTagName, fillTagName) {
	...
	for (const layoutBlockName of Object.keys(layoutBlockNodes)) {
		...
		// Выбираем последний блок, если в теге <extends> объявлено несколько блоков
